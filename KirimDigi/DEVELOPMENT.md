...
```bash
git remote add encore encore://katalog-undangan-digital-xpxi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/katalog-undangan-digital-xpxi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/katalog-undangan-digital-xpxi/settings/integrations/github)
